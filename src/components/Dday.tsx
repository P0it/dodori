...
import { color, tintBg, tintBorder, onPhotoBg, typeface } from '@/theme/tokens';
...
type Props = {
   ...
   * 어두운 판(onPhotoBg)을 깔고 테두리를 세워 어떤 사진 위에서도 읽히게 한다.
   */
  solid?: boolean;
      ...
      style={[
        {
          ...
          borderRadius: 999,
          backgroundColor: solid ? onPhotoBg : tintBg[tone],
          borderWidth: 1,
