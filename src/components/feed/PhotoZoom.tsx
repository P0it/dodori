...
type ZoomableProps = {
  ...
  transition?: number;
  /** 캐러셀 — 핀치가 가로 스크롤에 막히지 않게 함께 인식시킨다 */
  scrollRef?: React.RefObject<React.ComponentRef<typeof Animated.ScrollView> | null>;
};
 ...
 */
export function ZoomableImage({ source, style, contentFit, transition, scrollRef }: ZoomableProps) {
  ...
  const gesture = scrollRef ? pinch.simultaneousWithExternalGesture(scrollRef) : pinch;
